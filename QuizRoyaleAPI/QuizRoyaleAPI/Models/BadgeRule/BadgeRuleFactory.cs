...
namespace QuizRoyaleAPI.Models.BadgeRule
{
    ...
    public class BadgeRuleFactory
    {
        ...
        /// <exception cref="UnsupportedRuleException">Deze exceptie wordt gegooit zodra er geen badgeRule kan worden gevonden dat overeenkomt met de gegeven type.</exception>
